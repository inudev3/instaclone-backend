...
var resolvers = {
    ...
    Mutation: {
        editProfile: (0, users_utils_1.protectResolver)(function (_, _a, _b, info) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, shared_utils_1.uploadS3)(avatar, loggedInUser.id, "avatars")];
                        case 1:
                            avatarUrl = _c.sent();
                            _c.label = 2;
                        case 2:
                        ...
                        case 5:
                            ...
                            if (updatedUser.id) {
                                ...
                                return [2 /*return*/, { ok: false, error: "Could not update profile" }];
                            }
                            return [2 /*return*/];
                    }
                });
