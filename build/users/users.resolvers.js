    ...
    User: {
        totalFollowing: function (_a, _, _b) {
            ...
            return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_c) {
                return [2 /*return*/, client.user.count({ where: { followers: { some: { id: id } } } })];
            }); });
        },
        totalFollowers: function (_a, _, _b) {
            ...
            var client = _b.client;
            return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_c) {
                return [2 /*return*/, client.user.count({ where: { following: { some: { id: id } } } })];
            }); });
        },
        isFollowing: function (_a, __, _b) {
            var id = _a.id;
        ...
        photos: function (_a, _b, _c) {
            ...
            return client.photo.findMany(__assign({ where: { userId: id }, take: 9, skip: lastId ? 1 : 0 }, (lastId && { cursor: { id: lastId } })));
        },
    }
};
