...
var resolvers = {
    Mutation: {
        uploadPhoto: (0, users_utils_1.protectResolver)(function (_, _a, _b) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            hashtagObj = [];
                            if (caption) {
                                hashtagObj = (0, photos_utils_1.processHashtag)(caption);
                            }
                            return [4 /*yield*/, (0, shared_utils_1.uploadS3)(file, loggedInUser.id, "uploads")];
                        case 1:
                            fileUrl = _c.sent();
                            return [2 /*return*/, client.photo.create({
                                    data: __assign({ file: fileUrl, caption: caption, user: {
                                            connect: { id: loggedInUser.id }
                                        } }, ((hashtagObj === null || hashtagObj === void 0 ? void 0 : hashtagObj.length) > 0 && {
                                        hashtags: {
